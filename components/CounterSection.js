...
export default function Counter() {
	return (
		<section className=" mt-48 w-screen">
					...
					<div className=" grid md:grid-cols-4 md:text-lg text-sm text-white md:m-14 m-5 grid-cols-1 grid-rows-4">
						<div className=" flex justify-center align-middle sm:mb-0 mb-4">
							<ul className=" list-none">
								<li className=" info-num">
									<span>
										<VisibilitySensor>
											<CountUpComponent end={1500} />
										</VisibilitySensor>
									</span>
									<span>+</span>
								</li>
			...
			<div className=" flex justify-center sm:mt-10 mt-40 font-semibold pt">
				<span className=" md:text-7xl text-4xl text-aiesec-mid-grey text-center">
					AIESEC CREATES YOUNG LEADERS FROM
				</span>
			</div>
			<div className=" relative flex overflow-x-hidden">
				<div className=" animate-marquee whitespace-nowrap">
					<span className=" md:text-8xl text-6xl text-aiesec-mid-grey font-bold">
						<span className=" text-global-volunteer">VOLUNTEERING EXPERIENCES</span> &{" "}
						<span className=" text-global-teacher">PROFESSIONAL INTERNSHIPS</span> &{" "}
						<span className=" text-global-volunteer">TEACHING OPPORTUNITIES</span> &{" "}
						<span className=" text-global-teacher">MEMBERSHIP EXPERIENCES</span>.
					</span>
				</div>
			</div>
		</section>
